...
class RechargeLimitService:
    ...
    def _phone_key(
        ...
        if not secret:
            raise RuntimeError(
                "RECHARGE_LIMIT_HMAC_SECRET is required"
            )
    ...
    def reserve(
        ...
        *,
        ...
        try:
            ...
            # ---------------------------
            # Create / reactivate slot
            # ---------------------------

            db.execute(
                text(
                    """
                    INSERT INTO recharge_limit_events (
                        phone_key,
                        reservation_key,
                        status,
                        created_at,
